...
//  Cupcake Corner
//
//  Created by Cheng Liang(Louis) on 2022/9/24.
//
...
//        AsyncImage(url: URL(string: "https://hws.dev/img/dick.png")){ phase in
...
//        }
    ...
    var disabledFrom: Bool {
        username.count < 3 || email.count < 5
    }
